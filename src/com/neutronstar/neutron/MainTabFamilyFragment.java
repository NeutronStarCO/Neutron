...
public class MainTabFamilyFragment extends Fragment {
	public static MainTabFamilyFragment instance = null;
	private View view;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		instance = this;
		view = inflater.inflate(R.layout.main_tab_family, container, false);
		fmListView = (ListView) view.findViewById(R.id.maintab_family_listview);
		...
		fmAdapter = new FamilyMemberEntityAdapter(getActivity(), fmDataArrays);
		...
		fmListView.setOnItemClickListener(new OnItemClickListener(){
			...
			public void onItemClick(AdapterView<?> parentView, View view,
				...
				bl.putInt("userid", getActivity().getIntent().getExtras().getInt("userid"));
				bl.putSerializable("family_member_entity", fmDataArrays.get(position));
				intent.putExtras(bl);
				startActivityForResult(intent,MainTabFamily.TAG_MODIFY);
		...
		fmListView.setOnItemLongClickListener(new OnItemLongClickListener(){
			...
			public boolean onItemLongClick(AdapterView<?> parentView, View view,
				...
				intent.putExtras(bl);
				startActivityForResult(intent, MainTabFamily.TAG_DELETE);
				return false;
			}});
		
		view.findViewById(R.id.main_tab_family_add)
		.setOnClickListener(new OnClickListener(){
			public void onClick(View arg0) {
				...
				bl.putInt("userid", getActivity().getIntent().getExtras().getInt("userid"));
				intent.putExtras(bl);
				startActivityForResult(intent,MainTabFamily.TAG_ADD);
			}
		});
		...
		case Activity.RESULT_OK:
			...
			case MainTabFamily.TAG_DELETE:
				...
				new DeleteRelationTask().execute(SERVER.Address + "/" + "relation"
						, String.valueOf(getActivity().getIntent().getExtras().getInt("userid"))
