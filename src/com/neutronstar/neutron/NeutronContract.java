...
public final class NeutronContract {
	...
	public NeutronContract() {}
	 ...
	 public static abstract class ITEM 
	 {
		 ...
		 public static final int B_WBC	= 3;		// 白细胞计数
		 public static final int B_RBC	= 4;		// 红细胞计数
		 public static final int B_HGB	= 5;		// 血红蛋白
		 public static final int B_HCT	= 6;		// 血细胞压积
		 public static final int B_PLT	= 7;		// 血小板
		 public static final int B_PCT	= 8;		// 血小板压积
		 
		 public static final int U_SG	= 15;		// 尿比重
		 public static final int U_PH	= 16;		// 尿酸碱度
